...
let g:go_metalinter_enabled = ['gosimple', 'staticcheck', 'unused', 'ineffassign',  'goimports', 'misspell', 'errcheck']
let g:syntastic_go_gometalinter_args = ['--allow-parallel-runners']
